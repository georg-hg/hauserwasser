...
export default function Profile() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
      ...
      {!cardUrl && user?.role !== 'admin' && !user?.isKontrolleur && (
        <div className="flex items-start gap-3 p-4 bg-amber-50 rounded-xl border border-amber-200">
          ...
          <div>
            <p className="font-semibold text-amber-800">Fischereiberechtigungskarte fehlt</p>
            <p className="text-sm text-amber-700 mt-0.5">
              Bitte hinterlege deine Fischereiberechtigungskarte. Bei einer Kontrolle kann diese direkt in der App vorgezeigt werden.
            </p>
          </div>
        </div>
      )}
